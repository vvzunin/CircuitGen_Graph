...
VertexPtr OrientedGraph::generateMajority(GraphPtr targetGraph, VertexPtr a, VertexPtr b, VertexPtr c) {
    ...
    std::vector<VertexPtr> outputs = targetGraph->addSubGraph(majoritySubgraph, {a, b, c});
    return outputs.back();
}
