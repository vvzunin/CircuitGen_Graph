...
| Документ | Описание |
|----------|----------|
| [CONTRIBUTING.md](CONTRIBUTING.md) | Правила коммитов и вклада |
| [MergeRequests.md](MergeRequests.md) | Запросы на слияние: ревью, merge, ветки |
...
| [Subgraphs.md](Subgraphs.md) | Иерархия, подграфы, внешний RTL |
| [TestbenchGenerator.md](TestbenchGenerator.md) | Генерация Verilog testbench и Icarus |
