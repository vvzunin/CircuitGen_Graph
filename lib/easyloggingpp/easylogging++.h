...
public:
  ...
  Writer(LogMessage *msg, base::DispatchAction dispatchAction =
...
public:
  ...
  PerformanceTracker(const PerformanceTracker &t) :
      ...
      m_loggerId(t.m_loggerId), m_scopedLog(t.m_scopedLog), m_level(t.m_level),
      m_hasChecked(t.m_hasChecked), m_lastCheckpointId(t.m_lastCheckpointId),
      m_enabled(t.m_enabled), m_startTime(t.m_startTime),
